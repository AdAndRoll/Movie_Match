...
//Короче, нужно поменять немного интерфейс, добавить кнопку : подтвердить выбор жанров и годов
// и кнопку поиск фильмов, когда все пользователи будут готовы, кнопка поиска будет активна, до этого
// не активна, сейчас при нажатии на поиск фильмов у одного пользователя, вылетает у другого
